...
```bash
curl -fsSL https://raw.githubusercontent.com/ontograph/ontocode-cli/main/scripts/install/install.sh | sh -s -- --release 0.4.2.8
```
...
current pack is `content-pack-v7` and contains 25 agents and 28 skills.
...
`--release content-pack-v7` to pin the current pack.
...
Current internal development prerelease: `0.4.2.8` (`rust-v0.4.2.8`). Its Cargo
package and machine-readable CLI version is `0.4.2+8`, while GitHub release
...
See the [0.4.2.8 release notes](docs/releases/v0.4.2.8.md).
