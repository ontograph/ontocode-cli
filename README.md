...
```bash
curl -fsSL https://raw.githubusercontent.com/ontograph/ontocode-cli/main/scripts/install/install.sh | sh -s -- --release 0.4.2.9
```
...
current pack is `content-pack-v8` and contains 25 agents and 28 skills.
...
`--release content-pack-v8` to pin the current pack.
...
Current internal development prerelease: `0.4.2.9` (`rust-v0.4.2.9`). Its Cargo
package and machine-readable CLI version is `0.4.2+9`, while GitHub release
...
See the [0.4.2.9 release notes](docs/releases/v0.4.2.9.md).
