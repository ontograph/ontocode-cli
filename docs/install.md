...
Pin the current release explicitly with `--release 0.4.2.8`.

Release identity note: GitHub tags, installer inputs, and asset names use the
human release identity such as `0.4.2.8`, while the CLI reports the
machine-readable Cargo version such as `0.4.2+8`.

### Install the optional content pack

Content Pack v7 includes 25 agents and 28 skills. Install it into Ontocode home
with:
