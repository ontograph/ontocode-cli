...
- Project `.ontocode/config.toml` -> trusted-repo Codex settings such as sandbox, MCP, hooks, model, or reasoning defaults.
...
1. Run the install command yourself: `ontocode mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp`
