...
```bash
python3 $ONTOCODE_HOME/skills/codex-issue-digest/scripts/collect_issue_digest.py --labels tui exec --window-hours 24
```
...
```bash
python3 $ONTOCODE_HOME/skills/codex-issue-digest/scripts/collect_issue_digest.py --all-labels --window "past week" --limit-issues 10
```

Run the focused script tests:

```bash
pytest $ONTOCODE_HOME/skills/codex-issue-digest/scripts/test_collect_issue_digest.py
```
