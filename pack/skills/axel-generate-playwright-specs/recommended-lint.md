...
Discover testing docs, package scripts, ESLint config, Playwright/Cypress config, CI workflows, custom fixtures/commands, and seed specs. When the project already has an E2E lint command, run that exact repository-native command and merge its results with `axel-review-e2e-specs`:
