...
Spawn up to 6 subagents in parallel with non-overlapping scopes:
...
6) `S-06`: docs/ADR sources (`docs/adr/**/*.md`, `docs/adrs/**/*.md`, `docs/**/*ADR*.md`)
...
- `.memory-bank/adrs/` — normalized ADR records, including ADR evidence discovered under `docs/`
