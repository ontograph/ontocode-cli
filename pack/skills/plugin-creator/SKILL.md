...
- If the user specifies a different marketplace path, treat that marketplace as needing explicit installation via `ontocode plugin marketplace add`.
...
before giving reinstall instructions. Use `ontocode plugin marketplace add <path-to-marketplace-root>`
