---
name: axel-pyqt-testing
description: "PyQt/PySide6 testing with pytest-qt - qtbot fixture, waitSignal, mouse/keyboard simulation, dialog testing"
license: GPL-3.0-only
metadata:
  author: mte90
  version: 1.0.0
  vendored_from: https://github.com/CodeAtCode/oss-ai-skills
  vendored_ref: 30e045383bee16ac7c0c55702fdcc511ef57990c
...
- Applies to Python-based Qt test tools and prototypes. The production desktop
  client under `qt/` is C++ and is not covered by this skill.
- Use an isolated project environment with `pytest-qt` and the matching PyQt or
  PySide package approved for that tool; do not install global Python packages.
- Run headless tests with `QT_QPA_PLATFORM=offscreen`.
- Repeatable regressions belong in a committed test suite. Keep exploratory
  checks separate from product regression gates.
- Limit local builds to eight parallel jobs.
