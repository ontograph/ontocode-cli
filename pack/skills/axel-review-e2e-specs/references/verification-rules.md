...
| V6 | A writer/debugger cannot approve its own output | a distinct fresh-context, read-only axel-review-e2e-specs actor/process that did not write, debug, or repair the candidate reruns review | a distinct fresh-context, read-only axel-review-e2e-specs actor/process that did not write, debug, or repair the candidate reruns review |
